...
import { CloudUpload, AttachFile, CheckCircle, Error } from '@mui/icons-material';
    ...
    <Box>
      ...
      >
        ...
        <label htmlFor="file-input" style={{ cursor: 'pointer', display: 'block' }}>
          ...
          <Typography variant="body2" color="text.secondary" id="file-input-description">
        ...
        <Box sx={{ mt: 3 }}>
                  ...
                  secondary={
                    <Box sx={{ display: 'flex', alignItems: 'center', gap: 1, mt: 1 }}>
                      <Typography variant="body2">
                        {filesService.formatFileSize(fileWithStatus.file.size)}
                      </Typography>
                      <Chip
                        label={fileWithStatus.status}
                        size="small"
                                                 color={getStatusColor(fileWithStatus.status) as 'default' | 'primary' | 'secondary' | 'error' | 'info' | 'success' | 'warning'}
                        variant="outlined"
                      />
          ...
          {errorCount > 0 && (
            <Alert severity="error" sx={{ mt: 2 }} role="alert" aria-live="polite">
              {errorCount} file(s) failed to upload. Please check the errors above.
            </Alert>
          )}
        </Box>
      )}
